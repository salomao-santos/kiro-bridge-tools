...
|------|-----------|---------|
| [`skills/skill-to-power/`](./skills/skill-to-power/) | Skill → Power | Migrate a Skill into a Kiro Power |
...
Anyone moving between AI coding tools — **Antigravity, Cursor, Codex, GitHub Copilot** — and **Kiro IDE / Kiro CLI**.

- Coming **from another tool into Kiro?** Use `skill-to-power` to convert your Skills, or `power-creator` to author Powers from scratch.
